...
const Skills: React.FC = () => {
    const skills = {
        ...
        'Frontend Skills': [
          ...
          { name: 'Django', image: require('./images/django.png') },
        ...
        'Misc': [
          { name: 'aws', image: require('./images/aws.png') },
          { name: 'Heroku', image: require('./images/heroku.png') },
        ...
        <div key={category} className="mb-5">
          ...
          <div className="flex flex-wrap justify-center">
            {skills.map((skill, index) => (
              <div
                key={index}
                className="m-2 w-60 h-48 rounded-lg p-4 hover:bg-gray-200 transition-all duration-300 transform hover:scale-110 flex flex-col items-center justify-center space-x-2"
              >
