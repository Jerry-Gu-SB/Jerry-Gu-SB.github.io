...
const ProjectList = [
    ...
    {
      title: 'SplitBall',
      details: ['•	Inherited single player game as a team of two to repurpose as a multiplayer offline competitive game within the Unity Engine and C#', '•	Peep the repo: https://github.com/UVASGD/spring-2022-splitball'],
      image: StudentCourseApp,
    },
    {
